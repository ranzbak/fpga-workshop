...
//////////////////////////////////////////////////////////////////////////////
//                                                                          //
// https://github.com/jeras/sockit_owm/blob/master/hdl/sockit_owm.v         //
//                                                                          //
//////////////////////////////////////////////////////////////////////////////
...
`endif
  ...
  // CPU bus interface
  input            bus_ren,  // read  enable (active high)
  input            bus_wen,  // write enable (active high)
  input  [BAW-1:0] bus_adr,  // address      (should be 0 with just one divice)
  input  [BDW-1:0] bus_wdt,  // write data   (bus width dependent on the device connected)
  output [BDW-1:0] bus_rdt,  // read  data   (bus width dependent on the device connected)
  output           bus_irq,  // interrupt request (Not used for now)
  // 1-wire interface
